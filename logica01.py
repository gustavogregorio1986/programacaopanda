...
dados_brutos = [df.columns.tolist()] + df.values.tolist()
criar_tabela_pdf(dados_brutos, c, 50, 500)

# Salário Médio por Departamento
c.drawString(50, 460, "Salário Médio por Departamento:")
dados_salario_medio = [["Departamento", "Salário Médio"]] + salario_medio_por_departamento.reset_index().values.tolist()
criar_tabela_pdf(dados_salario_medio, c, 50, 300)
