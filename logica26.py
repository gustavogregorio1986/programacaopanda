...
# Filtrar os aviões pousados
avioes_pousados = df_avioes[df_avioes['on_ground'] == True]

# Verificar o DataFrame dos aviões pousados
print("DataFrame dos aviões pousados:")
print(avioes_pousados[['callsign', 'destination', 'arrival_time', 'on_ground']])

# Exibir as horas de chegada formatadas dos aviões pousados
print("\nHorários de chegada dos aviões pousados nos seus destinos:")
for _, row in avioes_pousados.iterrows():
